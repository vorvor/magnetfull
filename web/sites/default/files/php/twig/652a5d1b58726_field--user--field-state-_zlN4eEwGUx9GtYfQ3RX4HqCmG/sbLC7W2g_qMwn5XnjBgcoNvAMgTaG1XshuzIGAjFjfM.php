...
/* themes/mapvr/field--user--field-state-permissions--user.html.twig */
class __TwigTemplate_41df30ab0790acd8b06381d90f2b009b extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                // line 75
                echo "      ";
                $context["plusclass"] = twig_lower_filter($this->env, twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = (($__internal_compile_1 = (($__internal_compile_2 = $context["item"]) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["content"] ?? null) : null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["#options"] ?? null) : null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["entity"] ?? null) : null), "name", [], "any", false, false, true, 75), "value", [], "any", false, false, true, 75), 75, $this->source), [" " => "-"]));
                // line 76
                echo "
      <div";
                // line 77
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 77), "addClass", [0 => "field__item", 1 => ($context["plusclass"] ?? null)], "method", false, false, true, 77), 77, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/mapvr/field--user--field-state-permissions--user.html.twig";
    }
    ...
    {
        return array (  145 => 82,  141 => 80,  138 => 79,  128 => 77,  125 => 76,  122 => 75,  117 => 74,  113 => 72,  111 => 71,  105 => 70,  100 => 69,  96 => 67,  85 => 65,  80 => 64,  76 => 62,  65 => 60,  61 => 59,  56 => 58,  53 => 57,  51 => 56,  48 => 55,  46 => 52,  45 => 50,  43 => 46,  42 => 45,  41 => 44,  40 => 43,  39 => 41,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/mapvr/field--user--field-state-permissions--user.html.twig", "/home/wabisabe/magnet.wabisabee.com/web/themes/mapvr/field--user--field-state-permissions--user.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 41, "if" => 56, "for" => 59);
        static $filters = array("clean_class" => 43, "escape" => 58, "lower" => 75, "replace" => 75);
        static $functions = array();

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['clean_class', 'escape', 'lower', 'replace'],
                []
            );
